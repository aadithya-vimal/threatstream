...
| Threat observation | A real, attributed public-intelligence record representing a source-defined event, indicator, vulnerability-intelligence update, honeypot attempt, or aggregate—not necessarily a successful attack. |
