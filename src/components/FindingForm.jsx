...
const defaults = { title: '', description: '', severity: 'medium', source: 'manual', external_id: '', remediation: '', assignee_user_id: '' };

export const FindingForm = ({ finding, assignees = [], pending = false, submitLabel = 'Save finding', onSubmit, onCancel }) => {
  ...
  useEffect(() => setValues(finding ? {
    ...
    resolution_summary: finding.resolution_summary || '', assignee_user_id: finding.assignee?.id || ''
