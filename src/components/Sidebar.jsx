...
const groups = [
  {
    ...
    items: [
      ...
      { name: "Findings", path: "/findings", icon: "vulnerabilities" },
  ...
  },
  {
    label: "Workspace",
    items: [
      { name: "Teams", path: "/workspace/teams", icon: "administration" },
      {
        name: "Integrations",
  ...
  return (
    ...
    >
      <div className="sidebar__brand">
        <Brand compact={collapsed} onClick={onNavigate} />
      </div>
      ...
      <div className="sidebar__footer">
        <button
          type="button"
          className="btn btn-secondary sidebar__toggle"
          onClick={onToggle}
